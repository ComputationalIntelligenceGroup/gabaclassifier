...
1. Passes basics morphology quality such as 
It will not classify if some problems with morphology.  
...
- attached to soma, 
- length > 3000 and so on. Both at training and clasification.
